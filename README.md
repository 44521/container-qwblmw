...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qwblmw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qwblmw.containers.anotherwebservice.com/
...
```
git clone git@github.com:44521/container-qwblmw.git
cd container-qwblmw
```
...
```
docker attach container-qwblmw
```
